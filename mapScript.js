...
function createMarker(place) {
	...
	var infoWindowContent = '<p style="padding:0px; margin:0px;" onclick=\"window.location.href=\'food.html\'\">' + place.name + '<br> 5 min away</p>' +  
							...
							'<div class="col-xs-4"><img style="width:25px; height:25; padding-top:25px; margin:0px;" src="sugar2.png"/></div></div>';
